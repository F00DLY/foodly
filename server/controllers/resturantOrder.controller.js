...
const openorcloseresturent = asynchandler(async (req, res) => {
  try {
    const restaurantid = req.restaurant._id;
    const { active } = req.body;
    console.log('Request Data:', { active, restaurantid });
...
export { resturantshoworder, orderstatuschange, openorcloseresturent };
