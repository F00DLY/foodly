...
if(
    [Name,email,password,mobail].some((filed)=>filed?.trim()==="")
){
...
const user=await User.create({
 ...
 return res.status(201).json(
    new Apiresponse(200,createdUser,"user resistred succesfully")
 )
...
const {accessToken,refreshToken}=await genrateAccessAndRefrereshToken(user._id)
